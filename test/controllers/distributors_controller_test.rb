...
class DistributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distributor" do
    assert_difference('Distributor.count') do
      post distributors_url, params: { distributor: { address: @distributor.address, email: @distributor.email, name: @distributor.name, phoneNumber: @distributor.phoneNumber, photo: @distributor.photo } }, as: :json
    end
  ...
  test "should update distributor" do
    patch distributor_url(@distributor), params: { distributor: { address: @distributor.address, email: @distributor.email, name: @distributor.name, phoneNumber: @distributor.phoneNumber, photo: @distributor.photo } }, as: :json
    assert_response 200
  end
